...
export const mockProperties: PropertyItem[] = [
  ...
  },
  {
    ...
    listingHistory: [
      { date: "2024-03-15", event: "Draft Submitted for Verification", actor: "Selamawit Girma" },
    ],
    reportsCount: 0,
  },
  {
    ...
    agentAssigned: "Dawit Wolde",
    listingHistory: [
      { date: "2024-02-18", event: "Listing Submitted", actor: "Marta Haile" },
      { date: "2024-02-25", event: "Suspended due to conflicting ownership document", actor: "Admin System" },
    ],
    reportsCount: 2,
  },
];
