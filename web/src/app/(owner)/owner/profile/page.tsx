...
import { ShieldCheck, ShieldAlert, Award, User, Mail, Phone, Calendar } from 'lucide-react';
          ...
          <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-150 dark:border-rose-900/40 p-6 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-rose-700 dark:text-rose-500 mt-0.5">Please verify your ID to secure transactions and list unlimited properties.</p>
              </div>
            </div>
            <Link 
