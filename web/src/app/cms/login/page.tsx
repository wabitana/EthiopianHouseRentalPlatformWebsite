        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input name="email" type="email" required placeholder="admin@ethioproperty.et" className="bg-white text-slate-900" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">Password</label>
              <Input name="password" type="password" required placeholder="••••••••" className="bg-white text-slate-900" />
            </div>
